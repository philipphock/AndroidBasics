...
//			return fragment;
		...
		public CharSequence getPageTitle(int position) {
			String[] ret = {
					getString(R.string.sensor_section0_acc).toUpperCase(Locale.GERMANY),
					getString(R.string.sensor_section1_mag).toUpperCase(Locale.GERMANY),
					getString(R.string.sensor_section2_prox).toUpperCase(Locale.GERMANY),
					getString(R.string.sensor_section3_brig).toUpperCase(Locale.GERMANY),
					getString(R.string.sensor_section4_gyr).toUpperCase(Locale.GERMANY)
			};
			return ret[position];
